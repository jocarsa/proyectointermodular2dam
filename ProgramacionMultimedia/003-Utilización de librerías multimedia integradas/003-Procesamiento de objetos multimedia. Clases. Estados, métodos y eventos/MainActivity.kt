...
// --------------------------------------------------
enum class Escena {
    ALUMNOS, CONFIGURACION, EDICION, VIDEO, GRABACION_AUDIO
}
...
fun AppPantallas() {
    ...
    var alumnoEnGrabacionAudio by remember { mutableStateOf<Alumno?>(null) }
    ...
    when (escenaActual) {
        Escena.ALUMNOS -> {
            if (cargandoInicial) {
                ...
                PantallaGrupoCompleta(
                    ...
                    onIrAGrabarAudioAlumno = { alumnoAudio ->
                        alumnoEnGrabacionAudio = alumnoAudio
                        escenaActual = Escena.GRABACION_AUDIO
                    },
                    irAConfiguracion = {
        ...
        Escena.GRABACION_AUDIO -> {
            val alumnoGrabacion = alumnoEnGrabacionAudio

            if (alumnoGrabacion != null) {
                PantallaGrabacionAudioAlumno(
                    alumno = alumnoGrabacion,
                    volverAAlumnos = {
                        alumnoEnGrabacionAudio = null
                        escenaActual = Escena.ALUMNOS
                    },
