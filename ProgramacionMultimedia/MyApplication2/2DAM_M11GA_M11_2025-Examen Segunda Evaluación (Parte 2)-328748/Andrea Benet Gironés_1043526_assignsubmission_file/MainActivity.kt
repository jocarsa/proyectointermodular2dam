...
fun PantallaTareas() {
    ...
    var tituloInput by remember { mutableStateOf(value = "") }
    // TODO 6: crear un var llamado descripcionInput como String vacío usando remember

    var descripcionInput by remember { mutableStateOf(value = "") }
...
var filtro by remember {mutableStateOf(value = FiltroTareas.TODAS)}
        ...
        Button(
            onClick = {
                ...
                if (tituloInput.isBlank()){
                    ...
                    reproducirSonido(context , resId = R.raw.sonido_error)
                    return@Button
                }
                ...
                val tarea = Tarea(siguienteId, titulo, descripcion, estado = "pendiente")

                // TODO 12: añadir la tarea a la lista de pendientes y aumentar el ID

                val tarea = Tarea(id = siguienteId, titulo = titulo, descripcion = descripcion, estado = "Pendiente")
                ...
                reproducirSonido(context , resId = R.raw.notification.success)
            ...
            tareasPendientes.forEach { tarea ->
                ...
                TarjetaTareaPendiente(
                    ...
                    onCompletar = {
                        ...
                        sonido = R.raw.notification.success
                        reproducirSonido(context , resId = sonido)
                    },
                    onEliminar = {
                        tareasPendientes.remove(tarea)

                        // TODO 19: reproducir sonido de error
                        sonido = R.raw.sonido_error
                        reproducirSonido(context , resId = sonido)
                    }
                )
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                iconotarea = painterResource(id = R.drawable.iconotarea)
                Image(painter = iconotarea, contentDescription = "Icono tarea")
