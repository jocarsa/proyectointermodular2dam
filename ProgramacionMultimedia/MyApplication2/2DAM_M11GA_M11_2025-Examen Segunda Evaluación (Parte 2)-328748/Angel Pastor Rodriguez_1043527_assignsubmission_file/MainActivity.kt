...
import android.content.Contextimport android.media.MediaPlayer
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                mensaje = "Error, título inválido"
                    reproducirSonido(context, res.raw.sonido_error) //por terminar
                    return@Button
                }
                ...
                reproducirSonido(context, res.raw.sonido_acierto)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text("Añadir tarea")
            ...
            tareasPendientes.forEach { tarea ->
                ...
                TarjetaTareaPendiente(
                    ...
                    onEliminar = {
                        ...
                        reproducirSonido(context, res.raw.sonido_error)
                    }
                )
