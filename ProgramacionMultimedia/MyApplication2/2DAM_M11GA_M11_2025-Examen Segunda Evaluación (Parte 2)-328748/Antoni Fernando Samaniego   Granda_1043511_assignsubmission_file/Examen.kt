...
fun PantallaTareas() {
    ...
    // TODO 2: crear un val llamado tareasPendientes como lista mutable de Tarea con remember
        val tareasPendientes = remember {mutableListOf<Tarea>()}
    // TODO 3: crear un val llamado tareasCompletadas como lista mutable de Tarea con remember
        val tareasCompletadas =remember {mutableListOf<Tarea>()}
    ...
    // TODO 8: crear un var llamado filtro inicializado a FiltroTareas.TODAS usando remember
        var filtro by remember { mutableListOf(FiltroTareas.TODAS)}
            ...
            onClick = {
                ...
                // Si está vacío, mostrar mensaje de error, reproducir sonido de error y salir
                    if(tituloInput.isEmpty()){
                        mensaje = "El titulo esta vacio"; reproducirSonido(Context, raw/sonido_error)
                    }
                val titulo = tituloInput.trim()
                val descripcion = descripcionInput.trim()

                // TODO 11: crear un objeto Tarea con estado "Pendiente"
                val tarea = Tarea(1, titulo, descripcion, "Pendiente")
                ...
                reproducirSonido(Context, raw/sonido_acierto)
            ...
            tareasPendientes.forEach { tarea ->
                ...
                TarjetaTareaPendiente(
                    ...
                    onEliminar = {
                        ...
                        reproducirSonido(context = Context, resId = raw/sonido_error)
                    }
                )
            ...
            tareasCompletadas.forEach { tarea ->
                ...
                TarjetaTareaCompletada(
                    ...
                    onEliminar = {
                        ...
                        reproducirSonido(context, raw/sonido_error)
                    }
                )
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                Image(painterResource(id = R.drawable.iconotarea), contentDescription = "Icono de tarea")
...
fun reproducirSonido(context: Unit, resId: Int) {
