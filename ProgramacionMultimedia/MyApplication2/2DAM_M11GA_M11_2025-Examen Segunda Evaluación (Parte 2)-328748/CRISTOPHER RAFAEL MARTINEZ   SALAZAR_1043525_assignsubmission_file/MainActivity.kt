        ...
        Button(
            onClick = {
                ...
                if (tituloInput.isEmpty()) {
                    mensaje = "Esta cerca el Titulo"
                    reproducirSonido(context, R.raw.sonidoerror)
                }
                ...
                val tarea = tarea (id= siguienteId++, titulo, descripcion, estado ="Pendiente" )
                ...
                reproducirSonido(context, R.raw.sonidoacierto)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text("Añadir tarea")
