        ...
        Button(
            onClick = {
                ...
                if (titulo.isEmpty()) {
                    ...
                    reproducirSonido(context, R.raw.error)
                    return@Button
                }
                ...
                reproducirSonido(context, sonido_acierto.wav)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text("Añadir tarea")
        ...
        if (filtro == FiltroTareas.TODAS || filtro == FiltroTareas.PENDIENTES) {
            ...
            tareasPendientes.forEach { tarea ->
                ...
                TarjetaTareaPendiente(
                    ...
                    onEliminar = {
                        tareasPendientes.remove(tarea)
                        // TODO 19: reproducir sonido de err
                        reproducirSonido(context, sonido_error.wav)
                    }
                )
