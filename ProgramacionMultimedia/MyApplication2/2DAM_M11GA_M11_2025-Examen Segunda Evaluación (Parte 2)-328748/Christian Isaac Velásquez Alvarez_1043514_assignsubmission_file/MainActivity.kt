package com.example.christianvelasquez_examenmultimedia
        ...
        Button(
            onClick = {
                ...
                if (tituloInput == ""){
                    ...
                    reproducirSonido(context, resId = R.raw.error)
                    return@Button
                }
                ...
                reproducirSonido(context, resId = R.raw.acierto)
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text("Añadir tarea")
        ...
        if (filtro == FiltroTareas.TODAS || filtro == FiltroTareas.PENDIENTES) {
            ...
            tareasPendientes.forEach { tarea ->
                ...
                TarjetaTareaPendiente(
                    tarea = tarea,
                    onCompletar = {
                        tareasPendientes.remove(element = tarea)
        ...
        if (filtro == FiltroTareas.TODAS || filtro == FiltroTareas.COMPLETADAS) {
            ...
            tareasCompletadas.forEach { tarea ->
                ...
                TarjetaTareaCompletada(
                    tarea = tarea,
                    onMover = {
                        tareasCompletadas.remove(element = tarea)
