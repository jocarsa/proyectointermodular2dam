...
fun PantallaTareas() {
    ...
    var filtro by remember { mutableStateOf(value = value = FiltroTareas.TODAS) }
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Button(
                onClick = {
                    ...
                    FiltroTareas = FiltroTareas.TODAS
                },
            ...
            Button(
                onClick = {
                    ...
                    FiltroTareas = FiltroTareas.PENDIENTES
                },
                modifier = Modifier.weight(1f)
            ) {
                Text("Pendientes")
            ...
            Button(
                onClick = {
                    ...
                    FiltroTareas = FiltroTareas.COMPLETADAS
                },
                modifier = Modifier.weight(1f)
            ) {
                Text("Completadas")
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                Image(
                    painter = painterResource(R.drawable.iconotarea)
                )
