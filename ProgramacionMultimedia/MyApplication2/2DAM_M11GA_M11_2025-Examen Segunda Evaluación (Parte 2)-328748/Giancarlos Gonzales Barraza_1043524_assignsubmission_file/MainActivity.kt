package com.example.examentrimestral
...
import com.example.primer_proyecto.Filtro
import com.example.primer_proyecto.reproducirSonido
import kotlin.Int
...
fun PantallaTareas() {
    ...
    var descripcionInput by remember { mutableStateOf( value = String)}
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                Image(
                    painterResource(id = R.drawable.iconotarea)
                )
