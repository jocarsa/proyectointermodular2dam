...
fun PantallaTareas() {
    ...
    val tareasPendientes = remember { MutableStateListOf<Tarea>().apply }

    // TODO 3: crear un val llamado tareasCompletadas como lista mutable de Tarea con remember
    val tareasCompletas = remember { MutableStateOf<Tarea>().apply }
