    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                var tarea = Tarea(siguienteId, titulo, descripcion, "Pendiente")
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Button(
                onClick = {
                    ...
                    mensaje = "Mostrando todas las tareas"
                },
            ...
            Button(
                onClick = {
                    ...
                    mensaje = "Mostrando las tareas pendientes"
                },
                modifier = Modifier.weight(1f)
            ) {
                Text("Pendientes")
            ...
            Button(
                onClick = {
                    ...
                    mensaje = "Mostrando las tareas completadas"
                },
                modifier = Modifier.weight(1f)
            ) {
                Text("Completadas")
        ...
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                Image(
                    ...
                    contentDescription = "Imagen icono tarea",
                    modifier = Modifier.size(64.pd)
                )
