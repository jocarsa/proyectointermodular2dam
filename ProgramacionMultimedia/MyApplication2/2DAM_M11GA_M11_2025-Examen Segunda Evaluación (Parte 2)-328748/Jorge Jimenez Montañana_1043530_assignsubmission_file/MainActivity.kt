        ...
        Button(
            onClick = {
                ...
                if (tituloInput.isBlank){
                    mensaje = "Error, el titulo esta vacio"
                    reproducirSonido(context, R.raw.sonido_error.wav)
                }
                ...
                reproducirSonido(context, R.raw.sonido_acierto.wav)
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Row {
                ...
                Image(
                    painter = painterResource(id = R.drawable.icontarea),
                    contentDescirption = "Icono Tarea",
                    modifier = Modifier.size(40.pd)
                )
